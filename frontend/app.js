        ...
        try {
            ...
            switch (data.event) {
                ...
                case 'game_ended_by_disconnection':
                    ...
                    appendMessage(data.payload.message || 'O jogo foi encerrado e a sala voltou ao modo de espera.');
                    break;
                ...
                case 'game_ended_by_disconnection':
                    ...
                    showView('chat');
                    messagesDiv.innerHTML = '';
                    appendMessage('O jogo foi encerrado por falta de pessoas e a sala voltou para o modo de espera.');
                    break;
